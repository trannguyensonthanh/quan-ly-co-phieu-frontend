...
const Index = () => {
  ...
  const topGainers = [...(marketBoardData || [])]
    .sort((a, b) => {
      const aChange = (a.GiaKhopCuoi - a.GiaTC) / a.GiaTC;
      const bChange = (b.GiaKhopCuoi - b.GiaTC) / b.GiaTC;
      return bChange - aChange;
    })
    .slice(0, 3);

  const topLosers = [...(marketBoardData || [])]
    .sort((a, b) => {
      const aChange = (a.GiaKhopCuoi - a.GiaTC) / a.GiaTC;
      const bChange = (b.GiaKhopCuoi - b.GiaTC) / b.GiaTC;
  ...
  // const portfolioItems = mockStockOwnerships.filter(
  //   (item) => item.userId === "NDT001"
  // );
  // const totalStocksOwned = portfolioItems.length;
  // const totalQuantityOwned = portfolioItems.reduce(
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Chào mừng đến với sàn giao dịch chứng khoán Hà Nội
        </p>
      </div>
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Cổ phiếu có biến động giá mạnh nhất
              </CardDescription>
            </CardHeader>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {topGainers?.map((stock) => {
                    ...
                    const changePercent = formatPriceChange(
                      stock.GiaKhopCuoi,
                      stock.GiaTC
                    );
                    ...
                    return (
                      <Link
                        ...
                        className="block"
                      >
                        <div className="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                          <div className="flex justify-between items-center">
                            <div>
                              <span className="font-bold">{stock.MaCP}</span>
              ...
              <CardContent className="space-y-2">
                ...
                <div className="mt-2 border-t pt-2 flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {totalQuantityOwned.toLocaleString()}
                  </span>
                </div>
